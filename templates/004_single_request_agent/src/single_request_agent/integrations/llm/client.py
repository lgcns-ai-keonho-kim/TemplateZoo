...
디자인 패턴: 프록시, 데코레이터
참조: src/single_request_agent/shared/logging, src/single_request_agent/shared/exceptions
"""
...
from single_request_agent.integrations.llm._client_mixin import _LLMClientMixin
...
if TYPE_CHECKING:
    ...
    from single_request_agent.integrations.db.base import (
        BaseDBEngine,
        CollectionSchema,
    )
...
class LLMClient(_LLMClientMixin, BaseChatModel):
    ...
    def _resolve_logging(
        ...
        from single_request_agent.integrations.db import DBClient as _DBClient
        from single_request_agent.integrations.db.base import (
    ...
    def _build_llm_repository(
        ...
        from single_request_agent.shared.logging.llm_repository import (
            LLMLogRepository,
        )
