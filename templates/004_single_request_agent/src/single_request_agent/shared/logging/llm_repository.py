...
디자인 패턴: 저장소 패턴
참조: src/single_request_agent/shared/logging/models.py, src/single_request_agent/integrations/llm/client.py
"""
...
from single_request_agent.shared.logging.logger import LogRepository
from single_request_agent.shared.logging.models import LogContext, LogRecord
...
class LLMLogRepository(LogRepository):
    ...
    def add(self, record: LogRecord) -> None:
        from single_request_agent.integrations.db.base import Document
    ...
    def list(self) -> List[LogRecord]:
        from single_request_agent.integrations.db.base import Query
    ...
    def _ensure_ready(self) -> None:
        from single_request_agent.integrations.db.base import CollectionSchema
    ...
    def _ensure_db_available(self) -> None:
        from single_request_agent.integrations.db import DBClient  # noqa: F401
