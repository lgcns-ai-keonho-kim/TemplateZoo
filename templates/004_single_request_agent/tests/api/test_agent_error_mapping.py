...
디자인 패턴: 경계 단위 테스트
참조: src/single_request_agent/api/agent/routers/router.py, src/single_request_agent/shared/agent/services/agent_service.py
"""
...
from single_request_agent.api.agent.routers.router import _to_http_exception
