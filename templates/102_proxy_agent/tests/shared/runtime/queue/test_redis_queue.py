...
디자인 패턴: 어댑터 패턴
참조: src/tool_proxy_agent/shared/runtime/queue/redis_queue.py, src/tool_proxy_agent/shared/runtime/queue/model.py
"""
...
from tool_proxy_agent.shared.runtime.queue import QueueConfig, RedisQueue
