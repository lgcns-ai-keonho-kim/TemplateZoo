...
디자인 패턴: 상태 기반 단위 테스트
참조: src/tool_proxy_agent/shared/runtime/buffer/in_memory_buffer.py
"""
...
from tool_proxy_agent.shared.runtime.buffer import EventBufferConfig, InMemoryEventBuffer
