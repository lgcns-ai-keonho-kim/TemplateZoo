...
from tool_proxy_agent.api.chat.models import (
    SubmitChatRequest,
    SubmitChatResponse,
)
from tool_proxy_agent.api.const import CHAT_API_CREATE_PATH
from tool_proxy_agent.api.chat.routers.common import to_http_exception
from tool_proxy_agent.api.chat.services import get_service_executor
from tool_proxy_agent.shared.chat import ServiceExecutor
