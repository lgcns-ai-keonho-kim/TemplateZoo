...
참조: src/tool_proxy_agent/api/chat/routers/create_chat.py
"""
...
from tool_proxy_agent.api.chat.models.message import MessageResponse
...
class SubmitChatRequest(BaseModel):
    ...
    session_id: str | None = Field(
        default=None, description="기존 세션 식별자(없으면 신규 생성)"
    )
