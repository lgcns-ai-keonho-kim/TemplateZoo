...
디자인 패턴: 매퍼 함수
참조: src/tool_proxy_agent/api/chat/routers/list_sessions.py, src/tool_proxy_agent/api/chat/routers/list_messages.py
"""
...
from tool_proxy_agent.core.chat.models import ChatMessage, ChatSession
