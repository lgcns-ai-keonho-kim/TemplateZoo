...
디자인 패턴: 프록시, 데코레이터
참조: src/tool_proxy_agent/shared/logging, src/tool_proxy_agent/shared/exceptions
"""
...
from tool_proxy_agent.integrations.llm._client_mixin import _LLMClientMixin
from tool_proxy_agent.shared.exceptions import (
    BaseAppException,
    ExceptionDetail,
)
from tool_proxy_agent.shared.logging import (
    InMemoryLogger,
    LogContext,
    LogLevel,
    LogRepository,
...
if TYPE_CHECKING:
    ...
    from tool_proxy_agent.integrations.db.base import (
        BaseDBEngine,
        CollectionSchema,
    )
...
class LLMClient(_LLMClientMixin, BaseChatModel):
    ...
    def _resolve_logging(
        ...
        from tool_proxy_agent.integrations.db import DBClient as _DBClient
        from tool_proxy_agent.integrations.db.base import (
    ...
    def _build_llm_repository(
        ...
        from tool_proxy_agent.shared.logging.llm_repository import (
            LLMLogRepository,
        )
