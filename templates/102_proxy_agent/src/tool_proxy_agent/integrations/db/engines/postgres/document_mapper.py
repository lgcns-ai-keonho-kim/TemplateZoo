...
디자인 패턴: 매퍼 패턴
참조: src/tool_proxy_agent/integrations/db/engines/postgres/vector_adapter.py
"""
...
from tool_proxy_agent.integrations.db.engines.sql_common import vector_field
