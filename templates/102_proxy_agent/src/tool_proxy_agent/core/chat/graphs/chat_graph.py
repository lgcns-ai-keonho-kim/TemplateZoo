...
디자인 패턴: 모듈 조립 + 싱글턴
참조: src/tool_proxy_agent/shared/chat/graph/base_chat_graph.py
"""
...
from tool_proxy_agent.core.chat.nodes import (
    response_node,
...
from tool_proxy_agent.core.chat.state import ChatGraphState
from tool_proxy_agent.shared.chat.graph import BaseChatGraph
from tool_proxy_agent.shared.chat.interface import StreamNodeConfig
