...
디자인 패턴: 저장소 패턴
참조: src/tool_proxy_agent/integrations/embedding/client.py, src/tool_proxy_agent/shared/logging/models.py
"""
...
from tool_proxy_agent.shared.logging.models import LogContext, LogRecord
...
class EmbeddingLogRepository(LogRepository):
    ...
    def list(self) -> List[LogRecord]:
        ...
        from tool_proxy_agent.integrations.db.base import Query
    ...
    def _ensure_db_available(self) -> None:
        from tool_proxy_agent.integrations.db import DBClient  # noqa: F401
