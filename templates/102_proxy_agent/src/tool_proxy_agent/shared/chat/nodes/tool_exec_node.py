...
디자인 패턴: 실행 오케스트레이터
참조: src/tool_proxy_agent/shared/chat/tools/registry.py, src/tool_proxy_agent/shared/chat/tools/types.py
"""
...
from tool_proxy_agent.shared.chat.nodes._tool_exec_support import (
    _ToolExecSupportMixin,
)
from tool_proxy_agent.shared.chat.tools import (
    ToolCall,
    ToolRegistry,
    ToolResult,
)
