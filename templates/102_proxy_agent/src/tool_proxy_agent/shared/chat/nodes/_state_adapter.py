...
디자인 패턴: 어댑터
참조: src/tool_proxy_agent/shared/chat/nodes/llm_node.py, src/tool_proxy_agent/shared/chat/nodes/branch_node.py, src/tool_proxy_agent/shared/chat/nodes/message_node.py
"""
