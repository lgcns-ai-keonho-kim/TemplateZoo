...
참조: src/tool_proxy_agent/core/chat/nodes/tool_selector_prepare_node.py, src/tool_proxy_agent/shared/chat/nodes/_state_adapter.py
"""
...
from tool_proxy_agent.shared.chat.nodes._state_adapter import (
