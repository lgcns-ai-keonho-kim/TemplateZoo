...
참조: src/one_shot_agent/core/agent/nodes/response_node.py
"""
...
from one_shot_agent.core.agent.models import AgentMessage, AgentRole
...
class LLMNode:
    ...
    def __init__(
        ...
        *,
        ...
        self._logger = logger or create_default_logger(
            f"LLMNode:{normalized_node_name}"
        )
    ...
    def _build_messages(self, state: Mapping[str, Any]) -> list[BaseMessage]:
        ...
        messages: list[BaseMessage] = [
            SystemMessage(content=self._format_prompt(state))
        ]
