...
디자인 패턴: 어댑터
참조: src/one_shot_agent/shared/agent/nodes/llm_node.py, src/one_shot_agent/shared/agent/nodes/branch_node.py, src/one_shot_agent/shared/agent/nodes/message_node.py
"""
