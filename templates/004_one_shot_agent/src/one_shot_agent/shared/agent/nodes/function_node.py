...
참조: src/one_shot_agent/core/agent/nodes/tool_selector_prepare_node.py, src/one_shot_agent/shared/agent/nodes/_state_adapter.py
"""
...
from one_shot_agent.shared.agent.nodes._state_adapter import (
...
class FunctionNode:
    ...
    def __init__(
        ...
        *,
        fn: Callable[
            [Mapping[str, Any]], Mapping[str, Any] | Awaitable[Mapping[str, Any]]
        ],
        node_name: str,
        ...
        self._logger = logger or create_default_logger(
            f"FunctionNode:{normalized_node_name}"
        )
        ...
        try:
            ...
            if inspect.isawaitable(result):
                ...
                raise BaseAppException(
                    "비동기 함수는 arun으로 실행해야 합니다.", detail
                )
