...
디자인 패턴: 저장소 패턴
참조: src/one_shot_agent/shared/logging/models.py, src/one_shot_agent/integrations/llm/client.py
"""
...
from one_shot_agent.shared.logging.logger import LogRepository
from one_shot_agent.shared.logging.models import LogContext, LogRecord
...
class LLMLogRepository(LogRepository):
    ...
    def add(self, record: LogRecord) -> None:
        from one_shot_agent.integrations.db.base import Document
    ...
    def list(self) -> List[LogRecord]:
        from one_shot_agent.integrations.db.base import Query
    ...
    def _ensure_ready(self) -> None:
        from one_shot_agent.integrations.db.base import CollectionSchema
    ...
    def _ensure_db_available(self) -> None:
        from one_shot_agent.integrations.db import DBClient  # noqa: F401
