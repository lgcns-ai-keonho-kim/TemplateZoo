...
| 경로 | 역할 |
| --- | --- |
| `src/one_shot_agent/integrations/db/engines/postgres/engine.py` | PostgreSQL 엔진 |
| `src/one_shot_agent/integrations/db/engines/postgres/connection.py` | psycopg2 연결/pgvector 등록 |
| `src/one_shot_agent/integrations/db/engines/postgres/vector_store.py` | 확장/인덱스 처리 |
| `src/one_shot_agent/api/agent/services/runtime.py` | Chat 저장소 조립 지점 |
...
from one_shot_agent.integrations.db.engines.postgres import PostgresEngine
