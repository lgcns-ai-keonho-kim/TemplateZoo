...
| 파일 | 역할 |
| --- | --- |
| `src/text_to_sql/shared/exceptions/base.py` | 공통 예외 클래스 정의 |
| `src/text_to_sql/shared/exceptions/models.py` | 상세 모델 정의 |
| `src/text_to_sql/shared/exceptions/__init__.py` | 공개 API 제공 |
| `src/text_to_sql/api/chat/routers/common.py` | Chat API 예외를 HTTP 상태로 매핑 |
| `src/text_to_sql/api/ui/routers/common.py` | UI API 예외를 HTTP 상태로 매핑 |
