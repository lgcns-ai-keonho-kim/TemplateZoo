# db/engines/mongodb/schema_manager.md

소스 경로: `src/text_to_sql/integrations/db/engines/mongodb/schema_manager.py`
...
| 클래스 | 핵심 메서드 |
| --- | --- |
| `MongoSchemaManager` | `create_collection, delete_collection, add_column, drop_column` |
