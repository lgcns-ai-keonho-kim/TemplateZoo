...
참조: src/text_to_sql/shared/runtime/worker/worker.py, src/text_to_sql/shared/runtime/queue/in_memory_queue.py
"""
...
from text_to_sql.shared.runtime.queue import InMemoryQueue
