...
디자인 패턴: 저장소 패턴
참조: src/text_to_sql/integrations/embedding/client.py, src/text_to_sql/shared/logging/models.py
"""
...
from text_to_sql.shared.logging.logger import LogRepository
from text_to_sql.shared.logging.models import LogContext, LogRecord

if TYPE_CHECKING:
    from text_to_sql.integrations.db import DBClient
    from text_to_sql.integrations.db.base import CollectionSchema, Document
...
class EmbeddingLogRepository(LogRepository):
    ...
    def list(self) -> List[LogRecord]:
        ...
        from text_to_sql.integrations.db.base import Query
    ...
    def _default_schema(self, name: str) -> "CollectionSchema":
        from text_to_sql.integrations.db.base import CollectionSchema, ColumnSpec
    ...
    def _ensure_db_available(self) -> None:
        from text_to_sql.integrations.db import DBClient  # noqa: F401
