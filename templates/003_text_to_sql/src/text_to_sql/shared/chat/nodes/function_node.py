...
참조: src/text_to_sql/core/chat/nodes/schema_selection_parse_node.py, src/text_to_sql/shared/chat/nodes/_state_adapter.py
"""
...
from text_to_sql.shared.chat.nodes._state_adapter import coerce_state_mapping
