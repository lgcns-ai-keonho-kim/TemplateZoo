...
디자인 패턴: 프록시, 데코레이터
참조: src/text_to_sql/shared/logging, src/text_to_sql/shared/exceptions
"""
...
from text_to_sql.shared.logging import (
    InMemoryLogger,
    LogContext,
    LogLevel,
    LogRepository,
...
if TYPE_CHECKING:
    ...
    from text_to_sql.integrations.db.base import BaseDBEngine, CollectionSchema
...
class LLMClient(BaseChatModel):
    ...
    def _resolve_logging(
        ...
        from text_to_sql.integrations.db import DBClient as _DBClient
        from text_to_sql.integrations.db.base import BaseDBEngine as _BaseDBEngine

        db_client_cls: Any = _DBClient
        base_db_engine_cls: Any = _BaseDBEngine
        if (
