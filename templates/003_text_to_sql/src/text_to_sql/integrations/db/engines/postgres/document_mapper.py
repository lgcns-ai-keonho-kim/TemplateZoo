...
디자인 패턴: 매퍼 패턴
참조: src/text_to_sql/integrations/db/engines/postgres/vector_adapter.py
"""
...
from text_to_sql.integrations.db.base.models import CollectionSchema, Document, Vector
from text_to_sql.integrations.db.engines.sql_common import vector_field
