...
디자인 패턴: 모듈 싱글턴
참조: src/text_to_sql/core/chat/nodes/safeguard_node.py
"""
...
Class labels:
- PASS: safe request.
- PII: contains or requests high-credential required identity markers government-issued IDs, financial account details, medical records, or login credentials.
