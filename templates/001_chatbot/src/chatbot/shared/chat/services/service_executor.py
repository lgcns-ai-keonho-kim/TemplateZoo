...
from chatbot.shared.chat.interface import ChatServicePort, ServiceExecutorPort
...
from chatbot.shared.runtime.buffer import StreamEventItem
from chatbot.shared.runtime.queue import QueueItem
...
class ServiceExecutor(ServiceExecutorPort):
    ...
    _EVENT_DONE = "done"
    _EVENT_ERROR = "error"
    _ALLOWED_EVENT_TYPES = {_EVENT_START, _EVENT_TOKEN, _EVENT_DONE, _EVENT_ERROR}
