...
디자인 패턴: 파사드
참조: src/chatbot/integrations/db/base/engine.py, src/chatbot/integrations/db/base/query_builder.py
"""
...
from chatbot.integrations.db.query_builder.delete_builder import DeleteBuilder
from chatbot.integrations.db.query_builder.read_builder import ReadBuilder
from chatbot.integrations.db.query_builder.write_builder import WriteBuilder
...
class DBClient:
    ...
    def fetch(self, collection: str, query: Optional[Query] = None) -> List[Document]:
        ...
        with self._lock:
            ...
            return self._engine.query(collection, query, schema)
