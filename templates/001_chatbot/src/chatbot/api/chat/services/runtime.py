...
디자인 패턴: 모듈 조립 + 싱글턴
참조: src/chatbot/core/chat/graphs/chat_graph.py
"""
...
from chatbot.core.chat.graphs import chat_graph
from chatbot.shared.chat import ChatHistoryRepository, ChatService, ServiceExecutor
...
#   from chatbot.shared.runtime import RedisQueue
...
# 사용 위치:
# - get_chat_service():
#   - src/chatbot/api/chat/routers/get_chat_session.py
#   - src/chatbot/api/ui/services/__init__.py
# - get_service_executor():
#   - src/chatbot/api/chat/routers/create_chat.py
#   - src/chatbot/api/chat/routers/stream_chat_events.py
# - shutdown_chat_api_service():
#   - src/chatbot/api/main.py (lifespan 종료 구간)
#
# 의도:
