...
`src/single_request_tool_agent/integrations/embedding/client.py` 구현을 기준으로 현재 동작을 정리한다.
...
- `src/single_request_tool_agent/shared/logging`
- `src/single_request_tool_agent/shared/exceptions`
