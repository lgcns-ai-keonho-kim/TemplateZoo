...
| 경로 | 역할 |
| --- | --- |
| `src/single_request_tool_agent/integrations/db/engines/lancedb/engine.py` | LanceDB CRUD/벡터 검색 엔진 |
| `src/single_request_tool_agent/integrations/db/engines/lancedb/schema_adapter.py` | 스키마/차원 어댑터 |
| `src/single_request_tool_agent/integrations/db/client.py` | 엔진 공통 퍼사드 |
