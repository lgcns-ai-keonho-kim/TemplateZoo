...
`src/single_request_tool_agent/shared/agent/repositories/history_repository.py` 구현을 기준으로 현재 동작을 정리한다.
...
- `docs/shared/agent/repositories/schemas/session_schema.md`
- `docs/shared/agent/repositories/schemas/message_schema.md`
- `docs/shared/agent/repositories/schemas/request_commit_schema.md`
