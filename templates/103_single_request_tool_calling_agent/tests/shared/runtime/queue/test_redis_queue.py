...
디자인 패턴: 어댑터 패턴
참조: src/single_request_tool_agent/shared/runtime/queue/redis_queue.py, src/single_request_tool_agent/shared/runtime/queue/model.py
"""
...
from single_request_tool_agent.shared.runtime.queue import QueueConfig, RedisQueue
