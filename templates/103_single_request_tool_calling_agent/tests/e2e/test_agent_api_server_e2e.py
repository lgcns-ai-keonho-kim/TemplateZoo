...
디자인 패턴: 블랙박스 E2E 테스트
참조: tests/conftest.py, src/single_request_tool_agent/api/agent/routers/router.py
"""
...
def test_agent_api_returns_blocked_status_for_guardrail_case(chat_server_context) -> None:
