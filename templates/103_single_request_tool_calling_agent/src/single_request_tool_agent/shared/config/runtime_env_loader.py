...
디자인 패턴: 전략 패턴
참조: src/single_request_tool_agent/shared/config/loader.py, src/single_request_tool_agent/api/main.py
"""
...
class RuntimeEnvironmentLoader:
    ...
    4. `dev/stg/prod`인 경우 `src/single_request_tool_agent/resources/<env>/.env`를 로드한다.
    """
