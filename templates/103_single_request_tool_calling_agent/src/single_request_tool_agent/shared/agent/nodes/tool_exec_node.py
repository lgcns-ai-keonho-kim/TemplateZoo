...
디자인 패턴: 실행 오케스트레이터
참조: src/single_request_tool_agent/shared/agent/tools/registry.py, src/single_request_tool_agent/shared/agent/tools/types.py
"""
...
from single_request_tool_agent.shared.agent.nodes._tool_exec_support import (
