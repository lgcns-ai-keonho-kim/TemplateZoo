...
from single_request_tool_agent.integrations.llm._client_mixin import _LLMClientMixin
...
class LLMClient(_LLMClientMixin, BaseChatModel):
    ...
    def _build_llm_repository(
        ...
        from single_request_tool_agent.shared.logging.llm_repository import (
            LLMLogRepository,
        )
