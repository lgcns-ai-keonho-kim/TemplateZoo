...
디자인 패턴: 모듈 조립
참조: src/single_request_tool_agent/core/agent/prompts/tool_selector_prompt.py
"""
...
from single_request_tool_agent.core.agent.prompts import TOOL_SELECTOR_PROMPT
