"""
목적: core chat ToolExec 노드 조립체를 제공한다.
설명: 기본 ToolRegistry를 주입한 shared ToolExecNode 인스턴스를 노출한다.
디자인 패턴: 모듈 조립
참조: src/single_request_agent/shared/agent/nodes/tool_exec_node.py
"""

from __future__ import annotations

from single_request_agent.core.agent.tools.registry import registry
from single_request_agent.shared.agent.nodes import ToolExecNode
