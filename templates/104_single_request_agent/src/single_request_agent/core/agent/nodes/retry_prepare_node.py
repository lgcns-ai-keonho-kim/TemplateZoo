...
디자인 패턴: 모듈 조립 + 함수 주입
참조: src/single_request_agent/core/agent/nodes/_tool_execution_summary.py
"""
...
from single_request_agent.core.agent.nodes._tool_execution_summary import (
    summarize_retry_targets,
    summarize_tool_execution,
)
from single_request_agent.core.agent.tools.registry import registry
from single_request_agent.shared.agent.nodes import function_node
from single_request_agent.shared.agent.tools import build_tool_catalog_payload
