...
디자인 패턴: 단일 책임 원칙(SRP)
참조: src/single_request_agent/static
"""
...
from single_request_agent.shared.config import RuntimeEnvironmentLoader
...
from single_request_agent.api.agent.routers import router as agent_router
from single_request_agent.api.agent.services import shutdown_agent_api_service
from single_request_agent.api.health.routers.server import (
