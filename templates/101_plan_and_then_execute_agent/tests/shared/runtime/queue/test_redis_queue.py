...
디자인 패턴: 어댑터 패턴
참조: src/plan_and_then_execute_agent/shared/runtime/queue/redis_queue.py, src/plan_and_then_execute_agent/shared/runtime/queue/model.py
"""
...
from plan_and_then_execute_agent.shared.runtime.queue import QueueConfig, RedisQueue
