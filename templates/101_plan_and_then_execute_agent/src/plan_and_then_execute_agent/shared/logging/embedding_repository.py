...
디자인 패턴: 저장소 패턴
참조: src/plan_and_then_execute_agent/integrations/embedding/client.py, src/plan_and_then_execute_agent/shared/logging/models.py
"""
...
if TYPE_CHECKING:
    ...
    from plan_and_then_execute_agent.integrations.db.base import CollectionSchema, Document
