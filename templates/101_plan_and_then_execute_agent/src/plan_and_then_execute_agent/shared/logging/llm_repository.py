...
디자인 패턴: 저장소 패턴
참조: src/plan_and_then_execute_agent/shared/logging/models.py, src/plan_and_then_execute_agent/integrations/llm/client.py
"""
...
from plan_and_then_execute_agent.shared.logging.logger import LogRepository
from plan_and_then_execute_agent.shared.logging.models import LogContext, LogRecord

if TYPE_CHECKING:
    from plan_and_then_execute_agent.integrations.db import DBClient
    from plan_and_then_execute_agent.integrations.db.base import CollectionSchema, ColumnSpec, Document, Query
...
class LLMLogRepository(LogRepository):
    ...
    def add(self, record: LogRecord) -> None:
        from plan_and_then_execute_agent.integrations.db.base import Document
    ...
    def list(self) -> List[LogRecord]:
        from plan_and_then_execute_agent.integrations.db.base import Query
    ...
    def _ensure_ready(self) -> None:
        from plan_and_then_execute_agent.integrations.db.base import CollectionSchema
    ...
    def _default_schema(self, name: str) -> "CollectionSchema":
        from plan_and_then_execute_agent.integrations.db.base import CollectionSchema, ColumnSpec
    ...
    def _ensure_db_available(self) -> None:
        from plan_and_then_execute_agent.integrations.db import DBClient  # noqa: F401
