...
디자인 패턴: 전략 패턴
참조: src/plan_and_then_execute_agent/shared/config/loader.py, src/plan_and_then_execute_agent/api/main.py
"""
...
class RuntimeEnvironmentLoader:
    ...
    4. `dev/stg/prod`인 경우 `src/plan_and_then_execute_agent/resources/<env>/.env`를 로드한다.
    """
