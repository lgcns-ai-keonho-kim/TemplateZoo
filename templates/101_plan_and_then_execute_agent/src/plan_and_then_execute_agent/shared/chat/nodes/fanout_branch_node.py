...
디자인 패턴: 규칙 기반 라우터
참조: src/plan_and_then_execute_agent/core/chat/graphs/chat_graph.py, src/plan_and_then_execute_agent/shared/chat/nodes/_state_adapter.py
"""
