...
디자인 패턴: 어댑터 패턴
참조: src/plan_and_then_execute_agent/integrations/db/base/engine.py
"""
...
from plan_and_then_execute_agent.integrations.db.engines.sql_common import (
    SQLIdentifierHelper,
    ensure_schema,
    payload_field,
    resolve_source,
...
from plan_and_then_execute_agent.integrations.db.engines.postgres.condition_builder import (
    PostgresConditionBuilder,
)
from plan_and_then_execute_agent.integrations.db.engines.postgres.connection import (
    PostgresConnectionManager,
)
from plan_and_then_execute_agent.integrations.db.engines.postgres.document_mapper import (
    PostgresDocumentMapper,
)
from plan_and_then_execute_agent.integrations.db.engines.postgres.schema_manager import (
    PostgresSchemaManager,
)
from plan_and_then_execute_agent.integrations.db.engines.postgres.vector_adapter import (
    PostgresVectorAdapter,
)
from plan_and_then_execute_agent.integrations.db.engines.postgres.vector_store import (
    PostgresVectorStore,
)
