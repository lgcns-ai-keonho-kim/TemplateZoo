...
디자인 패턴: 매퍼 패턴
참조: src/plan_and_then_execute_agent/integrations/db/engines/postgres/vector_adapter.py
"""
...
from plan_and_then_execute_agent.integrations.db.base.models import CollectionSchema, Document, Vector
from plan_and_then_execute_agent.integrations.db.engines.sql_common import vector_field
