...
3. `src/plan_and_then_execute_agent/static/js/ui/grid_manager.js`
4. `src/plan_and_then_execute_agent/static/js/chat/api_transport.js`
5. `src/plan_and_then_execute_agent/static/js/chat/chat_cell.js`
6. `src/plan_and_then_execute_agent/static/js/chat/chat_presenter.js`
...
| 키 | 의미 | 값 |
| --- | --- | --- |
| `plan_and_then_execute_agent-theme` | 테마 유지 | `light` / `dark` |
| `plan_and_then_execute_agent-panel-collapsed` | 패널 접힘 여부 | `true` / `false` |
