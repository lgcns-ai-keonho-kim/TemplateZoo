...
| 파일 | 역할 |
| --- | --- |
| `src/plan_and_then_execute_agent/shared/logging/models.py` | `LogLevel`, `LogContext`, `LogRecord` 정의 |
| `src/plan_and_then_execute_agent/shared/logging/logger.py` | logging 공개 API 파사드 |
| `src/plan_and_then_execute_agent/shared/logging/_logger_base.py` | `Logger` 인터페이스 정의 |
| `src/plan_and_then_execute_agent/shared/logging/_log_repository_interface.py` | `LogRepository` 인터페이스 정의 |
| `src/plan_and_then_execute_agent/shared/logging/_in_memory_log_repository.py` | 인메모리 저장소 구현 |
| `src/plan_and_then_execute_agent/shared/logging/_in_memory_logger.py` | `InMemoryLogger` 구현 |
| `src/plan_and_then_execute_agent/shared/logging/_create_default_logger.py` | 기본 로거 팩토리 함수 |
| `src/plan_and_then_execute_agent/shared/logging/db_repository.py` | 일반 로그 DB 저장 구현 |
| `src/plan_and_then_execute_agent/shared/logging/llm_repository.py` | LLM 로그 DB 저장 구현 |
| `src/plan_and_then_execute_agent/shared/logging/__init__.py` | 공개 API 제공 |
