...
| 경로 | 역할 |
| --- | --- |
| `src/plan_and_then_execute_agent/integrations/db/engines/mongodb/engine.py` | MongoDB 엔진 본체 |
| `src/plan_and_then_execute_agent/integrations/db/engines/mongodb/connection.py` | 연결/DB 객체 초기화 |
| `src/plan_and_then_execute_agent/integrations/db/engines/mongodb/schema_manager.py` | 컬렉션 생성/필드 변경 |
| `src/plan_and_then_execute_agent/integrations/db/engines/mongodb/filter_builder.py` | Query -> Mongo 필터 변환 |
| `src/plan_and_then_execute_agent/api/chat/services/runtime.py` | 저장소 조립 지점 |
| `src/plan_and_then_execute_agent/shared/chat/repositories/history_repository.py` | `db_client` 주입형 저장소 |
