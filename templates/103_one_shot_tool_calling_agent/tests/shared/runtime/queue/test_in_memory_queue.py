...
디자인 패턴: 어댑터 패턴
참조: src/one_shot_tool_calling_agent/shared/runtime/queue/in_memory_queue.py, src/one_shot_tool_calling_agent/shared/runtime/queue/model.py
"""
...
from one_shot_tool_calling_agent.shared.runtime.queue import InMemoryQueue, QueueConfig
