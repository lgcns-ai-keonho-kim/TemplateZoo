...
디자인 패턴: 테스트 케이스
참조: src/one_shot_tool_calling_agent/integrations/db/engines/redis/engine.py
"""
...
from one_shot_tool_calling_agent.integrations.db.base import Vector, VectorSearchRequest
...
def _collection_schema(name: str, dimension: int | None):
    from one_shot_tool_calling_agent.integrations.db.base import CollectionSchema
