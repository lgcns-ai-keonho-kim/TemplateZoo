...
디자인 패턴: 테스트 케이스
참조: src/one_shot_tool_calling_agent/integrations/db/engines/elasticsearch/engine.py
"""
...
from one_shot_tool_calling_agent.integrations.db.engines.elasticsearch import ElasticsearchEngine
