...
3. 수동 조립 코드에서 MongoDB DB 클라이언트를 구성하는 예시
...
| 경로 | 역할 |
| --- | --- |
| `src/one_shot_tool_calling_agent/integrations/db/engines/mongodb/engine.py` | MongoDB 엔진 본체 |
| `src/one_shot_tool_calling_agent/integrations/db/engines/mongodb/connection.py` | 연결/DB 객체 초기화 |
| `src/one_shot_tool_calling_agent/integrations/db/engines/mongodb/schema_manager.py` | 컬렉션 생성/필드 변경 |
| `src/one_shot_tool_calling_agent/integrations/db/engines/mongodb/filter_builder.py` | Query -> Mongo 필터 변환 |
