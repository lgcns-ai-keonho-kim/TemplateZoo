...
`src/one_shot_tool_calling_agent/shared/agent/tools/registry.py` 구현을 기준으로 현재 동작을 정리한다.
...
- 중복 이름 등록을 허용하지 않습니다.
- 기본 설정에서 Tool 함수 모듈 경로는 `core/agent/tools` prefix 검증을 통과해야 합니다.
...
- `docs/shared/agent/tools/prompt_payload.md`
