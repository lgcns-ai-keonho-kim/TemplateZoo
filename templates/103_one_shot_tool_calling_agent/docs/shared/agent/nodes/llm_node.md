...
`src/one_shot_tool_calling_agent/shared/agent/nodes/llm_node.py` 구현을 기준으로 현재 동작을 정리한다.
...
- `AGENT_NODE_INPUT_INVALID`
- `AGENT_NODE_PROMPT_INPUT_INVALID`
- `AGENT_NODE_PROMPT_FORMAT_ERROR`
- `AGENT_STREAM_EMPTY`
