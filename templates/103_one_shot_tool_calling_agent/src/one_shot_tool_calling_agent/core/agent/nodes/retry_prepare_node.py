...
디자인 패턴: 모듈 조립 + 함수 주입
참조: src/one_shot_tool_calling_agent/core/agent/nodes/_tool_execution_summary.py
"""
...
from one_shot_tool_calling_agent.shared.agent.tools import build_tool_catalog_payload
