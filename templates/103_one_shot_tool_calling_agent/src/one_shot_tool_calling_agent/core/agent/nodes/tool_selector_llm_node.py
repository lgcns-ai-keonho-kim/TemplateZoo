...
디자인 패턴: 모듈 조립
참조: src/one_shot_tool_calling_agent/core/agent/prompts/tool_selector_prompt.py
"""
...
from one_shot_tool_calling_agent.core.agent.prompts import TOOL_SELECTOR_PROMPT
