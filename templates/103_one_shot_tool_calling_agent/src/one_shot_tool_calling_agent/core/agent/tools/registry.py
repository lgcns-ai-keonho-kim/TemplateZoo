...
디자인 패턴: 싱글턴 + 모듈 초기화
참조:
- src/one_shot_tool_calling_agent/core/agent/tools/math_tools.py
- src/one_shot_tool_calling_agent/core/agent/tools/api_get_weather.py
- src/one_shot_tool_calling_agent/core/agent/tools/draft_email.py
"""

from __future__ import annotations

from one_shot_tool_calling_agent.core.agent.tools.draft_email import draft_email
from one_shot_tool_calling_agent.core.agent.tools.math_tools import add_number
from one_shot_tool_calling_agent.core.agent.tools.api_get_weather import get_weather
