...
디자인 패턴: 모듈 싱글턴
참조: src/one_shot_tool_calling_agent/core/agent/nodes/safeguard_node.py
"""
...
_SAFEGUARD_PROMPT = textwrap.dedent(
    """
    You are a security classifier for user messages in a production tool agent system.
