...
디자인 패턴: 전략 패턴
참조: src/one_shot_tool_calling_agent/shared/logging/_in_memory_logger.py
"""
...
from one_shot_tool_calling_agent.shared.logging.models import LogContext, LogLevel
