...
참조: src/one_shot_tool_calling_agent/core/agent/nodes/tool_selector_prepare_node.py, src/one_shot_tool_calling_agent/shared/agent/nodes/_state_adapter.py
"""
