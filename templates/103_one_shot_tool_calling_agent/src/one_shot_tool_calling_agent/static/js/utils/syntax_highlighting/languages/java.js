...
(function () {
  ...
  window.App.syntax.registerLanguage(
    'java',
    [
      'class', 'public', 'private', 'protected', 'static', 'final', 'void', 'int',
      'long', 'double', 'float', 'boolean', 'new', 'return', 'if', 'else', 'for',
      'while', 'switch', 'case', 'try', 'catch', 'throw', 'extends', 'implements'
    ],
    '//'
  );
})();
