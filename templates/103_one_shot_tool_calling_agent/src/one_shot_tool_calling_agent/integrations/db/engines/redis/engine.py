...
from one_shot_tool_calling_agent.integrations.db.engines.redis.connection import (
    RedisConnectionManager,
)
from one_shot_tool_calling_agent.integrations.db.engines.redis.document_mapper import (
    RedisDocumentMapper,
)
from one_shot_tool_calling_agent.integrations.db.engines.redis.filter_evaluator import (
    RedisFilterEvaluator,
)
from one_shot_tool_calling_agent.integrations.db.engines.redis.keyspace import (
    RedisKeyspaceHelper,
)
from one_shot_tool_calling_agent.integrations.db.engines.redis.vector_scorer import (
    RedisVectorScorer,
)
...
class RedisEngine(BaseDBEngine):
    ...
    def __init__(
        ...
        self._connection = RedisConnectionManager(
            url=url, logger=self._logger, redis_module=redis
        )
