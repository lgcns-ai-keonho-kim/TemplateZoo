...
from one_shot_tool_calling_agent.integrations.db.engines.mongodb.connection import (
    MongoConnectionManager,
)
from one_shot_tool_calling_agent.integrations.db.engines.mongodb.document_mapper import (
    MongoDocumentMapper,
)
from one_shot_tool_calling_agent.integrations.db.engines.mongodb.filter_builder import (
    MongoFilterBuilder,
)
from one_shot_tool_calling_agent.integrations.db.engines.mongodb.schema_manager import (
    MongoSchemaManager,
)
...
class MongoDBEngine(BaseDBEngine):
    ...
    def query(
        ...
        return [
            self._document_mapper.from_record(data, resolved_schema) for data in cursor
        ]
