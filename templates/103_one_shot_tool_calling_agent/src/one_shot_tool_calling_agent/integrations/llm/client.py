...
디자인 패턴: 프록시, 데코레이터
참조: src/one_shot_tool_calling_agent/shared/logging, src/one_shot_tool_calling_agent/shared/exceptions
"""
...
from one_shot_tool_calling_agent.integrations.llm._client_mixin import _LLMClientMixin
...
class LLMClient(_LLMClientMixin, BaseChatModel):
    ...
    def chat(self, messages: Sequence[BaseMessage], **kwargs: Any) -> BaseMessage:
        ...
        if not content:
            detail = ExceptionDetail(
                code="LLM_STREAM_EMPTY", cause="stream produced empty content"
            )
    ...
    def _resolve_logging(
        ...
        from one_shot_tool_calling_agent.integrations.db import DBClient as _DBClient
        from one_shot_tool_calling_agent.integrations.db.base import (
    ...
    def _build_llm_repository(
        ...
        from one_shot_tool_calling_agent.shared.logging.llm_repository import (
            LLMLogRepository,
        )
