"""
목적: Chat 메시지 목록 조회 라우터를 제공한다.
설명: 세션별 메시지 목록 조회 엔드포인트를 정의한다.
디자인 패턴: 라우터 패턴
...
from base_template.api.chat.models import MessageListResponse
...
def list_messages(
    ...
    try:
        messages = service.list_messages(session_id=session_id, limit=limit, offset=offset)
