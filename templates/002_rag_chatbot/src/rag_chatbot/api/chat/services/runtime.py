...
from rag_chatbot.core.chat.graphs import chat_graph
from rag_chatbot.shared.chat import ChatHistoryRepository, ChatService, ServiceExecutor
...
#   from rag_chatbot.shared.runtime import RedisQueue
...
# 사용 위치:
# - get_chat_service():
#   - src/rag_chatbot/api/chat/routers/get_chat_session.py
#   - src/rag_chatbot/api/ui/services/__init__.py
# - get_service_executor():
#   - src/rag_chatbot/api/chat/routers/create_chat.py
#   - src/rag_chatbot/api/chat/routers/stream_chat_events.py
# - shutdown_chat_api_service():
#   - src/rag_chatbot/api/main.py (lifespan 종료 구간)
#
# 의도:
