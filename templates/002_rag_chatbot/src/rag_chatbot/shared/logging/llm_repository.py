...
디자인 패턴: 저장소 패턴
참조: src/rag_chatbot/shared/logging/models.py, src/rag_chatbot/integrations/llm/client.py
"""
...
if TYPE_CHECKING:
    ...
    from rag_chatbot.integrations.db.base import CollectionSchema, ColumnSpec, Document, Query
